    ...
    <>
      <Routes>
        ...
        <Route element={<StaffProtectedRoute />}>
          ...
          ></Route>
          <Route path="/staff/edit-event" element={<EditEventForm />}></Route>
          <Route path="/staff/edit-posts" element={<EditPosts />}></Route>
          <Route path="/staff/extended-shop" element={<ExtendedShop />}></Route>
          <Route
