...
const Games = () => {
    ...
    const game = {
        ...
        players: {                       // Сюда игроки могут сами добавляться или их добавляет создатель из пула зарегистрировавшихся на ивент игроков??
            "айди игрока1" : {place: "место игрока в матче", kills: "убийства"},
    ...
    return(
        <section className="w-[100%] min-h-[100vh] bg-gray-800">
            <div className="w-[1240px mx-auto] flex flex-col items-center p-[75px] gap-10">
                ...
                <div className="bg-yellow-400 w-[100%] h-[400px]">BANNER</div>

                <div className="flex bg-gray-600 w-[100%] justify-between rounded-[10px]">
                    <button className={!tournaments ? "text-white text-center w-[33%]" : "text-black text-center w-[33%] bg-yellow-400 rounded-[10px]"} onClick={handleTourClick}>Турниры</button>
                    <button className={!miniTournaments ? "text-white text-center w-[33%]" : "text-black text-center w-[33%] bg-yellow-400 rounded-[10px]"} onClick={handleMinTourClick}>Мини-турниры</button>
                    <button className={!practice ? "text-white text-center w-[33%]" : "text-black text-center w-[33%] bg-yellow-400 rounded-[10px]"} onClick={handlePracticeClick}>Практические</button>
                </div>
            </div>
        </section>
    )
