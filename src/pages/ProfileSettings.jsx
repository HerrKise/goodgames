                ...
                <div className="flex flex-col items-center">
                    ...
                    <form className="flex flex-col w-[400px] mt-[50px] gap-5" onSubmit={handleSubmit}>
                        ...
                        <div className="flex flex-col  border-white border-[1px] rounded-[5px] p-[5px]">
                            ...
                            <input type="email" placeholder="изменить" value={"" || email} className="px-[5px] py-[3px]" onChange={handleEmailChange}/>
                        </div>
                        <div className="flex flex-col  border-white border-[1px] rounded-[5px] p-[5px]">
                            <label>Ваш telegram: {selector.telegram}</label>
                            <input type="text" placeholder="изменить" value={"" || tg} className="px-[5px] py-[3px]" onChange={handleTgChange}/>
                        </div>
                        <div className="flex flex-col  border-white border-[1px] rounded-[5px] p-[5px]">
                            <label>Ваш Discord: {selector.discord}</label>
                            <input type="text" placeholder="изменить" value={"" || discord} className="px-[5px] py-[3px]" onChange={handleDiscordChange}/>
                        </div>
                        <div className="flex flex-col  border-white border-[1px] rounded-[5px] p-[5px]">
                            <label>Ваш YouTube: {selector.youtube}</label>
                            <input type="text" placeholder="изменить" value={"" || youTube} className="px-[5px] py-[3px]" onChange={handleYouTubeChange}/>
                        </div>
                        <div className="flex flex-col  border-white border-[1px] rounded-[5px] p-[5px] ">
