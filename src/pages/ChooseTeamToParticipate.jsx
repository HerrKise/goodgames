            ...
            {!isLoadingTeams && myTeamsList && (
                <section  className="bg-darkgrey min-h-[100vh]">
                    ...
                    <main className="wrap pt-28 text-white pb-20">
                        <h1 className="h1">Выберете команду для участия: </h1>
                        <ul className="py-5 space-y-3">
                            {myTeamsList.map((team) => (
                                <li key={team.id}  className="bg-grey rounded-xl p-5 relative w-full">
                                    <div className='flex items-center justify-between space-x-3'>
                                        ...
                                        <button
                                            className="rounded-lg bg-yellow p-2 text-darkgrey text-sm font-bold "
