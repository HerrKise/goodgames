            ...
            <div className="w-[1024px] mx-auto h-[900px] flex flex-col justify-center items-center">
                <form className="bg-[#161823] w-[500px] h-[600px] py-[30px] px-[20px] rounded-[20px]">
                    <div className="flex flex-col justify-center items-center border-b-[1px] border-gray-400 pb-[10px]">
                        <h2  className="text-white">Добро пожаловать на Good Games!</h2>
                        <p className="text-gray-500">Пожалуйста указывайте только достоверные данные!</p>
                    </div>
                    <div className="flex flex-col items-center justify-between h-[70%] py-[20px] border-b-[1px] border-gray-400">
                        ...
                        <div className="flex justify-between w-[80%] items-center">
                            <label className="text-gray-500">Повторите пароль</label>
                            <input
                                type="password-rep"
                                id="password-rep"
                                name="password-rep"
                    ...
                    <div className="flex justify-between items-center">
                        <div className="flex w-[250px] items-center justify-between">
                            ...
                            <label className="text-gray-500 ml-[20px]">Я подтверждаю, что согласен
                                с пользовательским соглашением и
                                политикой конфиденциальности</label>
                        </div>
                        <button className="bg-amber-500 w-[150px] h-[50px] rounded-[10px]">Готово!</button>
                    </div>
                </form>
            </div>
        </section>
