...
export const ChooseStageGroupParticipation = () => {
    ...
    return (
        <section className="bg-darkgrey min-h-[100vh]">
            {!isLoading && event && participantInfo && (
                <>
                    <NavLink
