    ...
    const news = [
        {
            ...
            date: "30.07.2022",
            description: "Каждый день GoodGames проводит бесплатные мини-турниры с призовым фондом!",
        },
        {
            title: "Бeсплатные мини-турниры",
            date: "30.07.2022",
    ...
    return (
        <section className="py-5 wrap">
            ...
            <ul className="grid grid-cols-2 gap-4">
                {news.map((newsitem, i) => {
                    return (
                        <li key={i} className="h-[220px] bg-gray-800 rounded-2xl px-2 py-3 relative overflow-clip group first:col-span-2 first:h-[360px]">
