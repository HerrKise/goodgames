...
export const NewsList = ({news}) => {
    ...
    return (
        <ul className="space-y-4 ">
            {news.map((newsitem, i) => {
                return (
                    <li key={i} className="bg-grey p-4 space-y-[10px] relative">
                        ...
                        <div className="relative z-10">
                            <div className="flex w-full justify-between items-center">
                                ...
                                <div className={newsitem.important ? "flex items-center bg-yellow text-darkgrey text-xs font-bold rounded py-[5px] px-3" : "hidden"}>
                                    ...
                                    <p className="ml-1">Важное</p>
                                </div>
                            </div>
                            <div  className="p flex items-center space-x-1">
                                <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g opacity="0.5">
                            ...
                            <p className="p break-words">{newsitem.description}</p>
                        </div>
                    </li>
                )
            })}
